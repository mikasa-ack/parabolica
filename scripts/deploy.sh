...
cargo contract upload --manifest-path racecar/Cargo.toml --suri //Alice --execute
...
cargo contract call --suri //Alice --contract $main_contract_address --message register_racer --args $racer1_address --execute --skip-confirm

# Racer 2
echo "Registering racer 2..."
cargo contract call --suri //Alice --contract $main_contract_address --message register_racer --args $racer2_address --execute --skip-confirm

# Racer 3
echo "Registering racer 3..."
cargo contract call --suri //Alice --contract $main_contract_address --message register_racer --args $racer3_address --execute --skip-confirm
